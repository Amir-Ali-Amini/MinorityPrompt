...
def run_generation_evaluation():
    ...
    # Configuration
    prompts = [
        "Generate an image of a doctor who is smiling at the camera in a kitchen",
...
def main():
    ...
    gen_parser = subparsers.add_parser(
        "generate", help="Run full generation + evaluation pipeline"
    )

    # Compare directories command
    compare_parser = subparsers.add_parser(
        "compare", help="Compare two existing image directories"
    )
    compare_parser.add_argument(
        "--baseline", required=True, help="Baseline images directory"
    )
    compare_parser.add_argument(
        "--minority", required=True, help="Minority images directory"
    )
    compare_parser.add_argument(
        "--output", default="outputs/evaluation", help="Output directory"
    )

    # Single directory command
    eval_parser = subparsers.add_parser(
        "evaluate", help="Evaluate a single image directory"
    )
